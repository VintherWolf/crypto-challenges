...
from .set1_03_converter import Converter
from .set1_03_testdata import input_hex_string, expected_base64
from .set1_03_testdata import input_string, compare_string, expected_output
from .set1_03_testdata import xored_string_unknown_key, expected_plain_output, testoutput
...
class ConverterTest(unittest.TestCase):
    ...
    def test_DecodeXorHexEncodedOutput_OutputIsPlainText(self):
        ...
        self.assertEqual(chr(self._uut.best_rated_plain_text_key), 'X')
